...
- `npm run lint` passed.
- `npm run test:unit` passed: 105 test files, 785 tests.
- `npm run test:coverage` passed: 105 test files, 785 tests.
...
![Functions](https://img.shields.io/badge/functions-91.84%25-brightgreen)
