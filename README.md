...
- `npm run lint` passed.
- `npm run test:unit` passed: 98 test files, 709 tests.
- `npm run test:coverage` passed: 98 test files, 709 tests.
...
![Statements](https://img.shields.io/badge/statements-96.35%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-89.95%25-green)
![Functions](https://img.shields.io/badge/functions-93.93%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-96.35%25-brightgreen)
