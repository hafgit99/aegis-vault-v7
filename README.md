...
- `npm run lint` passed.
- `npm run test:unit` passed: 103 test files, 769 tests.
- `npm run test:coverage` passed: 103 test files, 769 tests.
...
![Statements](https://img.shields.io/badge/statements-94.11%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-88.00%25-green)
![Functions](https://img.shields.io/badge/functions-92.10%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-94.11%25-brightgreen)
