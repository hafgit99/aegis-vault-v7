...
- `npm run lint` passed.
- `npm run test:unit` passed: 99 test files, 719 tests.
- `npm run test:coverage` passed: 99 test files, 719 tests.
...
![Statements](https://img.shields.io/badge/statements-96.25%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-88.58%25-green)
![Functions](https://img.shields.io/badge/functions-94.26%25-brightgreen)
