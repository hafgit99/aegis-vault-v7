...
- `npm run lint` passed.
- `npm run test:unit` passed: 105 test files, 787 tests.
- `npm run test:coverage` passed: 105 test files, 787 tests.
...
![Functions](https://img.shields.io/badge/functions-91.87%25-brightgreen)
