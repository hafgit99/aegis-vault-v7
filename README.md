...
- `npm run lint` passed.
- `npm run test:unit` passed: 105 test files, 795 tests.
- `npm run test:coverage` passed: 105 test files, 795 tests.
...
![Statements](https://img.shields.io/badge/statements-93.99%25-brightgreen)
...
![Lines](https://img.shields.io/badge/lines-93.99%25-brightgreen)
