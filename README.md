...
- `npm run lint` passed.
- `npm run test:unit` passed: 106 test files, 810 tests.
- `npm run test:coverage` passed: 106 test files, 810 tests.
...
![Branches](https://img.shields.io/badge/branches-87.92%25-green)
![Functions](https://img.shields.io/badge/functions-92.01%25-brightgreen)
