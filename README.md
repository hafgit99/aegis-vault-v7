...
- `npm run lint` passed.
- `npm run test:unit` passed: 107 test files, 818 tests.
- `npm run test:coverage` passed: 107 test files, 818 tests.
...
![Functions](https://img.shields.io/badge/functions-91.95%25-brightgreen)
