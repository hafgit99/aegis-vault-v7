...
- `npm run lint` passed.
- `npm run test:unit` passed: 92 test files, 654 tests.
- `npm run test:coverage` passed: 92 test files, 654 tests.
...
![Statements](https://img.shields.io/badge/statements-96.09%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-90.75%25-green)
![Functions](https://img.shields.io/badge/functions-93.43%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-96.09%25-brightgreen)
