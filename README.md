...
- `npm run lint` passed.
- `npm run test:unit` passed: 101 test files, 755 tests.
- `npm run test:coverage` passed: 101 test files, 755 tests.
...
![Statements](https://img.shields.io/badge/statements-93.89%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-88.14%25-green)
![Functions](https://img.shields.io/badge/functions-91.99%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-93.89%25-brightgreen)
