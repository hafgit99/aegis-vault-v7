...
- `npm run lint` passed.
- `npm run test:unit` passed: 99 test files, 714 tests.
- `npm run test:coverage` passed: 99 test files, 714 tests.
...
![Branches](https://img.shields.io/badge/branches-89.71%25-green)
![Functions](https://img.shields.io/badge/functions-94.15%25-brightgreen)
