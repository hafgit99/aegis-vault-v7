...
- `npm run lint` passed.
- `npm run test:unit` passed: 107 test files, 822 tests.
- `npm run test:coverage` passed: 107 test files, 822 tests.
...
![Statements](https://img.shields.io/badge/statements-94.07%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-87.89%25-green)
![Functions](https://img.shields.io/badge/functions-91.96%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-94.07%25-brightgreen)
