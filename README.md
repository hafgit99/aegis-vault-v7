...
- `npm run lint` passed.
- `npm run test:unit` passed: 92 test files, 662 tests.
- `npm run test:coverage` passed: 92 test files, 662 tests.
...
![Statements](https://img.shields.io/badge/statements-96.59%25-brightgreen)
...
![Lines](https://img.shields.io/badge/lines-96.59%25-brightgreen)
