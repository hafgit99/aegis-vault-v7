...
- `npm run lint` passed.
- `npm run test:unit` passed: 98 test files, 706 tests.
- `npm run test:coverage` passed: 98 test files, 706 tests.
...
![Statements](https://img.shields.io/badge/statements-96.33%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-89.90%25-green)
![Functions](https://img.shields.io/badge/functions-93.91%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-96.33%25-brightgreen)
