...
- `npm run lint` passed.
- `npm run test:unit` passed: 92 test files, 650 tests.
- `npm run test:coverage` passed: 92 test files, 650 tests.
...
![Statements](https://img.shields.io/badge/statements-96.04%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-90.46%25-green)
![Functions](https://img.shields.io/badge/functions-93.43%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-96.04%25-brightgreen)
