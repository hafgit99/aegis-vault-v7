...
- `npm run lint` passed.
- `npm run test:unit` passed: 105 test files, 797 tests.
- `npm run test:coverage` passed: 105 test files, 797 tests.
...
![Statements](https://img.shields.io/badge/statements-94.00%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-87.89%25-green)
![Functions](https://img.shields.io/badge/functions-91.92%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-94.00%25-brightgreen)
