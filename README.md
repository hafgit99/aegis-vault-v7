...
- `npm run lint` passed.
- `npm run test:unit` passed: 92 test files, 643 tests.
- `npm run test:coverage` passed: 92 test files, 643 tests.
...
![Statements](https://img.shields.io/badge/statements-95.87%25-brightgreen)
![Branches](https://img.shields.io/badge/branches-90.28%25-green)
![Functions](https://img.shields.io/badge/functions-92.92%25-brightgreen)
![Lines](https://img.shields.io/badge/lines-95.87%25-brightgreen)
