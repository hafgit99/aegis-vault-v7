...
- Continue smoke E2E expansion beyond the current 21 Chromium scenarios, with next focus on mobile smoke viewports and wa-sqlite active-backend restart coverage.
