...
- Continue smoke E2E expansion beyond the current 24 Chromium scenarios, with next focus on wa-sqlite active-backend restart coverage and Android-specific manual parity checks.
