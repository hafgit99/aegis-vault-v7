  ...
  return (
    <div className="space-y-2 sm:space-y-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
        <button
          onClick={onNewItem}
          className="surface-card surface-card-hover p-3 sm:p-4 rounded-xl flex items-center gap-3 text-left group cursor-pointer"
        >
          ...
          <div className="space-y-0.5">
            ...
            <p className="hidden sm:block text-[10px] text-on-surface-variant font-display">{t('dashboard.quick.newItem.description')}</p>
          </div>
        </button>
        ...
        >
          ...
          <div className="space-y-0.5">
            ...
            <p className="hidden sm:block text-[10px] text-on-surface-variant">{t('dashboard.quick.audit.description')}</p>
          </div>
        </button>
        ...
        >
          ...
          <div className="space-y-0.5">
            ...
            <p className="hidden sm:block text-[10px] text-on-surface-variant">{t('dashboard.quick.generator.description')}</p>
          </div>
        </button>
      </div>
    </div>
