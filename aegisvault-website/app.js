document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    tr: {
      ...
      "comp-r5-c2": "Tamamen Engelli (Air-Gapped)",
      ...
      "qlt-desc": "AegisVault 7'nin tüm kriptografik işlemleri, veri taşıma protokolleri ve arayüz durumları 530'dan fazla otomatik birim testi ile sürekli denetlenir.",
      ...
      "qlt-board-summary": "Test Dosyaları: 87 passed · Test Sayısı: 539 passed · Süre: 26.81s",
      "qlt-more-tests": "... 81 test dosyası daha başarıyla tamamlandı.",
    ...
    en: {
      ...
      "comp-r5-c2": "Fully Blocked (Air-Gapped)",
      ...
      "qlt-desc": "All cryptographic operations, data migration protocols, and user interface states in AegisVault 7 are continuously validated by over 530 automated unit tests.",
      ...
      "qlt-board-summary": "Test Files: 87 passed · Test Count: 539 passed · Duration: 26.81s",
      "qlt-more-tests": "... 81 more test files completed successfully.",
    ...
    zh: {
      ...
      "qlt-desc": "AegisVault 7 中的所有加密操作、数据迁移协议以及用户界面状态，均通过 530 多个自动单元测试进行持续验证。",
      ...
      "qlt-board-pass": "通过测试",
      "qlt-board-summary": "测试文件数：87 通过 · 测试点总数：539 通过 · 耗时：26.81 秒",
      "qlt-more-tests": "... 另外 81 个测试文件已成功运行完毕。",
      "terms-title": "使用条款",
